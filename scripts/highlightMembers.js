/* Eventually the database will be imported as a module and , thus, will reside in a separate
   file/database.*/
var members = [{name: "Kem Crimmins", 
				image: "https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-1/p160x160/15871830_10209893005334994_4941021641553554237_n.jpg?oh=8ab0978065b3645e54e8409e9e2a9844&oe=5940E351",
				...
				{name: "Brian Lynch",
				image: "https://avatars1.githubusercontent.com/u/11574695?v=3&s=460",
...
function getHighlightedMembers() {
	var highlightedMember;
	for (var i = 0; i < 3; i++) {
		highlightedMember = randomMember();
		displayMember(highlightedMember, i);
	}
}
/* On document ready, dynamically load random three members	*/
